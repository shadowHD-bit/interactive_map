...
let placesGroup = [
    {
        ...
        color: 'blue',
        places: [
            {coordinates: [56.478094, 84.950290], adress: 'Проспект Ленина, 85а', info:'Доступная пиццерия в центре города с интересным интерьером и очень вкусными пиццами.', name: 'Make Love Pizza'},
            {coordinates: [56.483895, 84.982243], adress: 'Комсомольский проспект, 14а', info:'Decs1', name: 'Make Love Pizza'},
            {coordinates: [56.464510, 84.984812], adress: 'Проспект Кирова, 58', info:'Кафе таджикской кухни с очень доступными ценами и вкусной выпечкой.', name: 'Мир'},
            {coordinates: [56.491767, 84.970295], adress: 'Улица Яковлева, 42', info:'', name: 'ОШ'},
            ...
            {coordinates: [56.458746, 84.962255], adress: 'Улица Учебная, 37Б/1', info:'Одна из популярных шаурмечных города с большими порциями и приятными ценами.', name: 'Ростовская шаурма'},
            {coordinates: [56.503364, 85.012597], adress: 'Улица Иркутский тракт, 37', info:'Одна из популярных шаурмечных города с большими порциями и приятными ценами.', name: 'Ростовская шаурма'},
